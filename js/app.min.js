(() => {
          ...
          void 0 !== a &&
            ...
            (w(e[i]) && w(r[i])
              ? r[i].__swiper__
                ...
                : b(e[i], r[i])
              : !w(e[i]) && w(r[i])
              ? ((e[i] = {}), r[i].__swiper__ ? (e[i] = r[i]) : b(e[i], r[i]))
              : (e[i] = r[i]));
        }
      }
    }
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              L = e.isHorizontal() ? k(r, "width", !0) : k(r, "height", !0);
            else {
              const e = t(a, "width"),
                s = t(a, "padding-left"),
                i = t(a, "padding-right"),
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        f && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e)),
          B(o, f, s.slideVisibleClass),
          B(o, m, s.slideFullyVisibleClass),
          (o.progress = r ? -c : c),
      ...
      if (r.params.loop)
        if (r.virtual && r.params.virtual.enabled) n += r.virtual.slidesBefore;
          ...
          if (
            ...
            i && s && "auto" !== r.params.slidesPerView && !a && (o = !1),
            o)
          ) {
            const i = s
              ? e < r.activeIndex
  ...
  function Z(e) {
    ...
    for (
      ...
      void 0 !== o[e + t]
        ? (h || (u >= o[e] && u < o[e + t])) && ((m = e), (v = o[e + t] - o[e]))
        : (h || u >= o[e]) &&
          ((m = e), (v = o[o.length - 1] - o[o.length - 2]));
    }
    let w = null,
      b = null;
    a.rewind &&
    ...
    if (p > a.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (S >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? w : m + y)
          : t.slideTo(m)),
      ...
      (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl)
        ? r.target === t.navigation.nextEl
          ? t.slideTo(m + y)
          : t.slideTo(m)
        : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : m + y),
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const h = l.direction && l.direction !== i.direction,
            m = i.loop && (l.slidesPerView !== i.slidesPerView || h),
            f = i.loop;
          h && s && e.changeDirection(), b(e.params, l);
  ...
  class de {
    constructor() {
      ...
      (n.__swiper__ = !0),
        (n.support = _()),
        (n.device = $({ userAgent: t.userAgent })),
        (n.browser = G()),
        (n.eventsListeners = {}),
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((r) => {
          if (!s[r] && !0 === s.auto) {
            let a = E(e.el, `.${i[r]}`)[0];
            a || ((a = C("div", i[r])), (a.className = i[r]), e.el.append(a)),
              (s[r] = a),
              (t[r] = a);
          }
        }),
  ...
  function he(e) {
    ...
    function p() {
      ...
      if (
        ...
        if (
          (s.dynamicBullets &&
            ((n = k(r[0], t.isHorizontal() ? "width" : "height", !0)),
            c.forEach((e) => {
  ...
  Object.keys(le).forEach((e) => {
    ...
    window.addEventListener("load", function (e) {
      document.querySelector(".how__slider-main") &&
        new de(".how__slider-main", {
          modules: [pe, he],
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
          ...
          speed: 600,
          allowTouchMove: !1,
          pagination: { el: ".how__swiper-pagination", clickable: !0 },
          navigation: {
        ...
        document.querySelector(".how__slider-image") &&
          new de(".how__slider-image", {
            modules: [pe, ge, he],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
  ...
  async function we() {
    try {
      const e = "0x54ce775fa5f42789460dc63906b332a84a95d937";
        ...
        if ("click" === t.type) {
          ...
          if (s.closest("[data-goto]")) {
            const i = s.closest("[data-goto]"),
              ...
              l = i.dataset.gotoSpeed ? i.dataset.gotoSpeed : 500,
